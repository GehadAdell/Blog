        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7 text-center">
                    <h5>
                        {!! nl2br(
                            e("I'm a Fresh Backend developer with experience working on a variety of web and application development projects.
                    ...
                    <a href="https://web.facebook.com/ana.b.rawsh" class="btn btn-primary">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/gehad-adel-772b22202/" class="btn btn-info">
                        <i class="fab fa-linkedin-in"></i>
                    </a>
                    <a href="https://github.com/GehadAdell" class="btn btn-white">
